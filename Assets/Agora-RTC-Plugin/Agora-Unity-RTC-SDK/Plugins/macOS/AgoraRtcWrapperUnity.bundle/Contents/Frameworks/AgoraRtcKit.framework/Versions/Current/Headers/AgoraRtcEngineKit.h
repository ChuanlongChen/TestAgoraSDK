 ...
 */
- (BOOL)isSupportPortraitCenterStage NS_SWIFT_NAME(isSupportPortraitCenterStage());
 ...
 * - < 0: Failure.
 */
- (int)enablePortraitCenterStage:(BOOL)enabled NS_SWIFT_NAME(enablePortraitCenterStage(_:));
