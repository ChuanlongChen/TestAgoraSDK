...
typedef NS_ENUM(NSInteger, AgoraAudioOutputRouting) {
    ...
    /**
     * 10: (macOS only) The virtual sound card.
     */
    AgoraAudioOutputRoutingVirtual = 10,
    /**
     * 11: (macOS only) The Continued Routing peripherals.
     */
    AgoraAudioOutputRoutingContinuity = 11,
};
